...
public class Alumnos extends JFrame implements ActionListener {
    ...
    public Alumnos() {
        ...
        lCorreo.setBounds(100, 230, 100, 40);
        lCorreo.setForeground(Color.WHITE);
        lNombre.setBounds(100, 280, 100, 40);
        lNombre.setForeground(Color.WHITE);
        lApellido.setBounds(100, 330, 100, 40);
        lApellido.setForeground(Color.WHITE);
        lCarrera.setBounds(100, 380, 100, 40);
        lCarrera.setForeground(Color.WHITE);
        lAsesoria.setBounds(100, 430, 150, 40);
        lAsesoria.setForeground(Color.WHITE);
        lTutor.setBounds(100, 480, 150, 40);
        lTutor.setForeground(Color.WHITE);
        lArea.setBounds(100, 530, 150, 40);
        ...
        t6.setBounds(235, 435, 40, 25);
        t7.setBounds(205, 485, 170, 25);
        t9.setBounds(200, 535, 100, 25);
...
//        tb1.setBackground(Color.BLUE);
        ...
        tb1.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                ...
                t9.setText((String.valueOf(tb1.getValueAt(seleccion, 7))));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (p.equals("Consultar")) {
            ...
            try {
                ...
                ps = conn.prepareStatement("SELECT no_cuenta,correo,nombres,apellidos,carrera,asesorias_tomadas,tutor_asignado,area  FROM alumnos WHERE no_cuenta = ?");
                ...
                if (rs.next()) {
                    ...
                    t2.setText(rs.getString("correo"));
                    t3.setText(rs.getString("nombres"));
                    t4.setText(rs.getString("apellidos"));
                    t5.setText(rs.getString("carrera"));
                    t6.setText(rs.getString("asesorias_tomadas"));
                    t7.setText(rs.getString("tutor_asignado"));
                    t9.setText(rs.getString("area"));
            ...
            try {
                ...
                ps = conn.prepareStatement("INSERT INTO usuarios_cade (no_cuenta, correo, nombres, apellidos, tipo_usuario) VALUES(?,?,?,?,?)");
                ...
                ps = conn.prepareStatement("INSERT INTO alumnos (no_cuenta, correo, nombres, apellidos,carrera,asesorias_tomadas,tutor_asignado,area) VALUES(?,?,?,?,?,?,?,?)");
                ...
                int eleccion = JOptionPane.showOptionDialog(this, "Realmente desea Registrar Alumno?", p, 0, 0, null, botones, this);
            ...
            try {
                conn = Conexion.getConnnection();
                ps = conn.prepareStatement("UPDATE alumnos SET no_cuenta =?,correo =?, nombres =?, apellidos =?,carrera =?,asesorias_tomadas =?,tutor_asignado =?, area = ? WHERE no_cuenta = ? ");
...
//                ps.setString(6, t1.getText());
                String botones[] = {"si", "no"};
                int eleccion = JOptionPane.showOptionDialog(this, "Realmente desea Modificar Alumno?", p, 0, 0, null, botones, this);
                if (eleccion == JOptionPane.YES_OPTION) {
                    ps.executeUpdate();
            ...
            try {
                conn = Conexion.getConnnection();
                ps = conn.prepareStatement("DELETE FROM alumnos WHERE no_cuenta = ?");
                ...
                String botones[] = {"si", "no"};
                int eleccion = JOptionPane.showOptionDialog(this, "Realmente desea Eliminar Alumno?", p, 0, 0, null, botones, this);
                if (eleccion == JOptionPane.YES_OPTION) {
                    ps.executeUpdate();
            ...
            try {
                ...
                rs = s.executeQuery("select no_cuenta,correo, nombres,apellidos, carrera, asesorias_tomadas, tutor_asignado, area from alumnos");
            ...
            try {
                ...
                parrafo.add("Formato de alumnos © \n\n");
                ...
                try {
                    ...
                    PreparedStatement pst = conn.prepareStatement("select * from alumnos");
